...
class AutorDb(models.Model):
    ...
    fecha_fallecimiento = models.DateField(verbose_name="Fecha_Fallecimiento", null=True, blank=True)
    profesion = models.CharField(verbose_name="Profesion", max_length=50)
    nacionalidad = models.CharField(verbose_name="Nacionalidad", max_length=75)
    ...
    def __str__(self) -> str:
        return self.nombre # pylint: disable=invalid-str-return
